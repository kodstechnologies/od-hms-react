                    ...
                    <div className="card">
                      <div className="card-body">
                        <div className="heading-detail ">
                          ...
                          <p>
                            Hello, I am Dr. Rajesh Verma, a Gynaecologist at Sanjivani Hospital, Surat.
                      ...
                      <div className="card-body">
                        <div className="tab-content-set">
                          <ul className="nav">
                            ...
                            <li>
                              <Link to="/admin/doctors/view-profile/doctor-setting">
                                <span className="set-about-icon me-2">
                                  <img
                                    src={menuicon16}
                                    alt="#"
                        ...
                        <div className="hello-park">
                          <p>
                            I completed my graduation in Gynecological Medicine from
                            the well-known and renowned institution of India –
                            All India Institute of Medical Sciences (AIIMS), New Delhi, in 2000-01,
                            which is affiliated with Delhi University.
                            I was a university rank holder in exams from 1996-01.
                          </p>
                          <p>
                            Worked as Professor and Head of the Department
                            at Civil Hospital, Rajkot, Gujarat, from 2003-2015.
                          </p>
                        </div>
                            ...
                            <table className="table mb-0 border-0 custom-table profile-table">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  <td>2005-2014</td>
                                  <td>MBBS</td>
                                  <td>Grant Medical College, Mumbai</td>
                                  <td>
                                    <button className="custom-badge status-green ">
                                      Distinction
                                    </button>
                            ...
                            <table className="table mb-0 border-0 custom-table profile-table">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>King Edward Memorial (KEM) Hospital, Mumbai</td>
                                  <td>
                                    <button className="custom-badge status-green ">
                                      Excellence
                                    </button>
