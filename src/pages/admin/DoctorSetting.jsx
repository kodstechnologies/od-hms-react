                            ...
                            <div className="row">
                                <div className="col-sm-12">
                                    <ul className="breadcrumb">
                                        <li className="breadcrumb-item"><Link to="/admin/doctors">Doctors </Link></li>
                                            ...
                                            <div className="card">
                                                <div className="card-body">
                                                    <div className="tab-content-set">
                                                        <ul className="nav">
                                                            <li>
                                                                <Link to="/admin/doctors/view-profile"><span className="set-about-icon me-2"><img src={doctor} alt /></span>About me</Link>
                                                            </li>
                                                            <li>
