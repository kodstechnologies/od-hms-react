...
import PatientChart from "../../components/dashboard/PaitentChart";
                ...
                <div className="card-body">
                  <ul className="notice-list">
                    <li>
                      ...
                      <p>
                        A free health check-up camp is scheduled for March 15th.
                    ...
                    <li>
                      ...
                      <p>
                        COVID-19 booster doses are available. Visit the
                        vaccination center for details.
                      </p>
                    </li>
                    <li>
                      <h5>Training for Staff</h5>
                      <p>
                        Mandatory training session for new staff on March 20th
                        in Conference Room B.
                      </p>
                    </li>
                    <li>
                      <h5>Emergency Contact</h5>
                      <p>For any medical emergency, contact +91 9876543210.</p>
                    </li>
                  </ul>
                </div>
              </div>
